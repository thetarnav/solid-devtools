...
describe('reconcileStructure', () => {
  ...
  test('initial', () => {
    const { roots, nodeList } = reconcileStructure(prevRoots, { updated, removed, partial: false })
    prevRoots = roots
  ...
  test('update', () => {
    ...
    const { roots, nodeList } = reconcileStructure(prevRoots, { updated, removed, partial: true })
    prevRoots = roots
