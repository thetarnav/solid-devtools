        ...
        <Scrollable contentProps={{ class: 'flex bg-panel-1' }}>
            ...
            >
                ...
                <Show when={dgraph.graph() && order()}>
                    {untrack(() => {
                        const flowOrder = (): readonly NodeID[] => order()!.flowOrder
                        const depthMap = (): Record<NodeID, number> => order()!.depthMap
                                                ...
                                                {sourceId => (
                                                    <Show when={dgraph.graph()![sourceId]}>
                                                        <Line
                                                            ...
                                                            source_flow_index={flowOrder().indexOf(
                                                                sourceId,
                                                            )}
