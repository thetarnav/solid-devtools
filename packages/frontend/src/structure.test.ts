    ...
    let updated: debug.StructureUpdates['updated'] = {
        '#1': {
            '#1': {
                ...
                children: [
                    {id: '#2', name: 'child', type: debug.NodeType.Component, children: []},
                    {
                        id: '#3',
                        name: 'child2',
                        type: debug.NodeType.Effect,
                        children: [
                            {id: '#4', name: 'child3', type: debug.NodeType.Component, children: []},
                            {
                                id: '#5',
                                type: debug.NodeType.Root,
                                children: [
        ...
        updated = {
            ...
            '#8': {
                '#8': {
                    ...
                    type: debug.NodeType.Root,
                    children: [
                        {id: '#9', name: 'child6', type: debug.NodeType.Component, children: []},
                        {
                            ...
                            children: [
                                ...
                                {id: '#7', name: 'child5', type: debug.NodeType.Effect, children: []},
                            ],
                        },
                    ],
                },
        ...
        updated = {
            ...
            '#5': {
                '#5': {
                    ...
                    type: debug.NodeType.Root,
                    children: [
                        {id: '#6', name: 'child4', type: debug.NodeType.Component, children: []},
                        {
                            id: '#7',
                            name: 'child5',
                            type: debug.NodeType.Effect,
                            ...
                            children: [
                                {
                                    id: '#11',
                                    name: 'child7',
                                    type: debug.NodeType.Computation,
                                    children: [],
                                },
                            ],
                        },
